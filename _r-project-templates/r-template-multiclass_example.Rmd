---
title: "Multi-Class Classification Model for [Project Name] Using R version 12"
author: "David Lowe"
...
ANALYSIS: [Sample Paragraph - The baseline performance of the machine learning algorithms achieved an average accuracy of 69.75%. Two algorithms (Random Forest and Gradient Boosting) achieved the top accuracy metrics after the first round of modeling. After a series of tuning trials, Random Forest turned in the top overall result and achieved an accuracy metric of 77.66%. After applying the optimized parameters, the Random Forest algorithm processed the testing dataset with an accuracy of 84.62%, which was even better than the prediction from the training data.]
